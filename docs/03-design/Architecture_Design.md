...
| :---------------------------------------------------------------------- | :----------------------- | :-------------------------------- | :--------------------------------------------------------------------------------------------- |
| `POST /api/staffs`                                                      | `StaffService`           | `createStaff`                     | `PostgresStaffRepository`, `BcryptPasswordHasher`                                              |
| `PATCH /api/staffs/{id}`                                                | `StaffService`           | `updateStaff` / `deactivateStaff` | `PostgresStaffRepository`                                                                      |
| `GET /api/staffs`                                                       | `StaffService`           | `listStaff`                       | `PostgresStaffRepository`                                                                      |
